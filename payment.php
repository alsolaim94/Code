...
<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
  ...
  <input type="hidden" name="item_number" value="123">
      <br> Price<br>
  <input type="double" name="amount" value="15.00">
    <br> <br>
    <h1>billing </h1>
  <input type="name" name="first_name" value="<?php echo $firstName; ?>">  
  <input type="name" name="last_name" value="<?php echo $lastName; ?>">
  ...
  <input type="zip" name="zip" value="42101">
